...
<div id="main_info_cont">
	...
	<div id="main_info_center">
		<div id="main_info_center_in">
			...
			<div class="content_style2">
				<div class="content_style2_heading">
					<h3>Want your projects here?</h3>
				</div>
				<div class="content_style2_info">
				<p>			          This is the place to show off your skills. If you have developed any software which you think could be useful for others, you can share that here. The software you want to publish here should follow <a href="http://www.gnu.org/copyleft/gpl.html" target="_blank">GPLv3.0</a> terms and conditions. You can mail your software <a href="http://en.wikipedia.org/wiki/Tar_%28file_format%29" target="_blank">tarball</a> to <a href="mailto:mailglug@gmail.com">(mailglug@gmail.com)</a>.
