		...
		<div id="main_info_center_in">
			<div class="content_style2">
				<div class="content_style2_heading">
					<h3>Linux Alternatives for Windows based Applications</h3>
				</div>
				<div class="content_style2_info">
				
					<p>Most of us use windows as the first operating system in their life. So, we become addicted of using windows and switching to GNU/Linux is more difficult. Actually all the applications that we use in windows have an alternative implementation(even better) for GNU/Linux based operating system. Here i am giving a list of some popular applications of windows and their linux alternatives.</p>
		<br />
